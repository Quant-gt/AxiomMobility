...
pwa = (PWA / "index.html").read_text(encoding="utf-8")
app = (NATIVE / "App.tsx").read_text(encoding="utf-8")
api = (NATIVE / "src" / "api.ts").read_text(encoding="utf-8")
location_task = (NATIVE / "src" / "locationTask.ts").read_text(encoding="utf-8")
server = (ROOT / "server.py").read_text(encoding="utf-8")
domain = (ROOT / "backend_domain.py").read_text(encoding="utf-8")
extended = (ROOT / "backend_extended.py").read_text(encoding="utf-8")
manifest = (PWA / "manifest.json").read_text(encoding="utf-8")
